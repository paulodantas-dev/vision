...
export async function ServerSidebar({ serverId }: ServerSidebarProps) {
  ...
  return (
    <div className="flex flex-col h-full w-full bg-slate-200 dark:bg-slate-800 text-slate-950 dark:text-slate-100">
      ...
      <ScrollArea className="flex-1">
        ...
        <Separator className="bg-slate-300 dark:bg-slate-700 rounded-md" />
        {/* {!!textChannels?.length && (
          <div className="mb-2">
            <ServerSection
